...
func ImageResize(forThumb bool, oriFilePath string, newFilePath string, width uint, height uint) {
	file, err := os.Open(oriFilePath)
	if err != nil {
		LOG.Error("resize Image Error: %v", err)
	}
